...
!\[思维模型总览图](./images/model\_map.png)



\*上图由 Draw.io 绘制，展示了 27 个模型之间的关联与应用场景。\*
...
\- `images/` – 每张卡片的配图（Draw.io 源文件 + 导出的 PNG）

\- `templates/` – 卡片模板，方便统一格式

\- `discussions/` – 讨论记录 / 链接（正式讨论推荐使用 \[Issues](../../issues)）
...
欢迎补充案例、修正描述或新增图示。请先阅读 `templates/card\_template.md` 保持格式统一。
